    ...
    extend: {
      ...
      colors: {
        ...
        platform: {
          ...
          discord: "hsl(var(--platform-discord))",
          imessage: "hsl(var(--platform-imessage))",
          instagram: "hsl(var(--platform-instagram))",
          telegram: "hsl(var(--platform-telegram))",
          messenger: "hsl(var(--platform-messenger))",
          tiktok: "hsl(var(--platform-tiktok))",
          slack: "hsl(var(--platform-slack))",
          reddit: "hsl(var(--platform-reddit))",
          snapchat: "hsl(var(--platform-snapchat))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
