...
export const EMAIL_TEMPLATES = {
    ...
    emails: [
      {
        ...
        body: 'Hey Sarah,\n\nAttached the revised Q3 deck with the changes we talked about in standup. Can you take a look before the board meeting tomorrow? Specifically the CAC numbers on slide 9.\n\nThanks,\nDavid'
      },
      {
        id: 'e2',
  ...
  jobOffer: {
    subject: 'Your offer for Senior Product Designer at Veily',
    ...
    emails: [
      {
        ...
        body: 'Hey there,\n\nYour refund for the Premium annual plan has been processed. It should show up in your account within 5-7 business days.\n\nTotally understand if it wasn\'t the right fit. If you have a sec, we\'d love to know what we could do better.\n\nThanks,\nVeily Support'
      }
    ]
  } as EmailState,
    ...
    emails: [
      {
        ...
        fromParticipantId: 'p1',
        dateTime: '9:30 AM',
        body: 'Hey,\n\nRead your LinkedIn post on the future of SaaS mockups. It really resonated with some stuff we\'re working on.\n\nI\'m in town next Tues-Wed, would love to grab a quick coffee if you have 20 mins. No agenda, just curious to hear more about your approach.\n\nDavid'
      }
    ]
  } as EmailState,

  projectKickoff: {
    subject: 'Website redesign timeline and first steps',
    ...
    emails: [
      {
        ...
        fromParticipantId: 'p1',
        dateTime: 'Just now',
        body: 'Welcome to Veily!\n\nYou can start creating mockups right away with no setup needed. Pick a template or start from scratch.\n\nIf anything feels confusing, just reply to this email. We actually read these.'
      }
    ]
  } as EmailState,
  ...
  formalGreeting: {
    subject: 'Quick intro from Sarah at Global Tech',
    attachment: '',
    participants: [
  ...
  eventInvite: {
    subject: 'You\'re invited: Product Design Meetup on Jan 18',
