    ...
    const renderActionIcons = () => (
        <div className="flex items-center justify-between mt-3 max-w-[420px]">
            <div className="flex items-center gap-2 group cursor-pointer">
                ...
                <span className={cn("text-[15px]", isDark ? "text-zinc-500 group-hover:text-blue-400" : "text-gray-500 group-hover:text-blue-500")}>{state.metrics.comments}</span>
            </div>
            ...
            <div className="flex items-center gap-2 group cursor-pointer">
                ...
                <span className={cn("text-[15px]", isDark ? "text-zinc-500 group-hover:text-green-400" : "text-gray-500 group-hover:text-green-500")}>{state.metrics.reposts}</span>
            </div>
            ...
            <div className="flex items-center gap-2 group cursor-pointer">
                ...
                <span className={cn("text-[15px]", isDark ? "text-zinc-500 group-hover:text-pink-400" : "text-gray-500 group-hover:text-pink-500")}>{state.metrics.likes}</span>
            </div>
            ...
            <div className="flex items-center gap-2 group cursor-pointer">
                ...
                <span className={cn("text-[15px]", isDark ? "text-zinc-500 group-hover:text-blue-400" : "text-gray-500 group-hover:text-blue-500")}>{state.metrics.views}</span>
            </div>
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-1 overflow-hidden">
                                ...
                                <span className={cn("text-[15px]", isDark ? "text-zinc-500" : "text-gray-500")}>
            ...
            <div className="flex-1 min-w-0 pb-2">
                ...
                <div className="flex items-center justify-between mt-3 max-w-[420px]">
                    ...
                    <div className="flex items-center gap-2 group cursor-pointer">
                        ...
                        {parseInt(item.metrics.likes) > 0 && <span className={cn("text-[15px]", isDark ? "text-zinc-600" : "text-gray-400")}>{item.metrics.likes}</span>}
                    </div>
