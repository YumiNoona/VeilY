...
const captureElement = async (
    ...
    try {
        return await domToCanvas(captureTarget, {
            scale: safeScale,
            width,
            height,
            backgroundColor: null,
            timeout: 15000,
            maximumCanvasSize: 64_000_000,
...
/**
 * Common utility to export a DOM element as an image using the browser's
 * SVG foreign-object renderer so text layout matches the live preview.
